...
namespace Metrics.ElasticSearch
{
    ...
    public enum RollingIndexType
    {
        ...
        /// <summary>
        ///     the Elastic Index would be the INDEX-yyyy-MM-dd, use this to be able to delete Index by day for maintenance
        ///     purposes
        /// </summary>
        Daily,
    ...
    public class ApplicationInfo : IApplicationInfo
    {
        ...
        public ApplicationInfo() : this(Assembly.GetEntryAssembly().GetName().Name, Assembly.GetEntryAssembly().GetName().Version.ToString())
        {
        }
